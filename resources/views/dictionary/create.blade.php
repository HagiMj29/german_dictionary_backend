    ...
    <div class="col-lg-12">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <div class="row">
                    <div class="col-lg-12">
                        <form action="/dictionary/store" method="POST" >
                            @csrf
                            @method('post')
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" name="kata_jerman" type="text" placeholder="Masukkan Kata Jerman">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" name="contoh_penggunaan_jerman" type="text" placeholder="contoh_penggunaan_jerman">
                            </div>
                            <div class="form-group">
